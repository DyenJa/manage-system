...
public interface TableMapper {
    ...
    boolean updateJacket(PoJacket poJacket) throws Exception;
    ...
    boolean updateDress(PoDress poDress) throws Exception;
    ...
    boolean updateJumpsuit(PoJumpsuit poJumpsuit) throws Exception;
    ...
    boolean updatePoloShirt(PoPoloShirt poPoloShirt) throws Exception;
    ...
    boolean updateShort(PoShort poShort) throws Exception;
    ...
    boolean updateBlousesAndShirts(PoBlousesAndShirts poBlousesAndShirts) throws Exception;
    ...
    boolean updateCoat(PoCoat poCoat) throws Exception;
    ...
    boolean updatePantAndTrousers(PoPantAndTrousers poPantAndTrousers) throws Exception;
    ...
    boolean updateTshirt(PoTshirt poTshirt) throws Exception;
    ...
    boolean updateTanktops(PoTanktops poTanktops) throws Exception;
    ...
    boolean updateVestsAndWaistcoats(PoVestsAndWaistcoats poVestsAndWaistcoats) throws Exception;
    ...
    boolean updateSkirt(PoSkirt poSkirt) throws Exception;
